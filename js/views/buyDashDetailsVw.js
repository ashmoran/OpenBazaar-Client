...
module.exports = Backbone.View.extend({
  ...
  events: {
    'change .js-buyDashWizardQuantity': 'changeQuantity',
  ...
  render: function(){
    ...
    loadTemplate('./js/templates/buyDashDetails.html', function(loadedTemplate) {
  ...
  setQuantity: function(quantity){
    var newAttributes = {},
        ...
        newDASHDisplayPrice = app.intlNumFormat(this.model.get('vendorDASHPrice') * quantity, 8),
        newBTCShippingDisplayPrice = app.intlNumFormat(this.model.get('currentShippingBTCPrice') * quantity, 8),
        // DASHTODO: this all needs reworking for DASH, assuming fiat for now
        ...
        // DASHTODO: shipping
        totalDASHDisplayPrice = (this.model.get('vendorDASHPrice') + this.model.get('currentShippingBTCPrice')) * quantity,
        // DASHTODO: I haven't changed moderator prices for DASH because it's a later scenario
        moderatorPriceBTC = moderatorPercentage ? totalDASHDisplayPrice * moderatorPercentage : 0,
    ...
    this.$('.js-buyWizardDASHPrice').html(newDASHDisplayPrice+"DASH");
    ...
    newAttributes.totalDASHDisplayPrice = totalDASHDisplayPrice;
    // DASHTODO: remove
    console.log("WOOF");
